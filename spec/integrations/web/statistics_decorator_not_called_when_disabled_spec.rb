...
# When statistics.interval.ms is set to 0, even with the Web UI enabled,
# Karafka::Core::Monitoring::StatisticsDecorator#diff should never be called.
...
# With statistics.interval.ms set to 0, diff should never have been called even with Web UI
