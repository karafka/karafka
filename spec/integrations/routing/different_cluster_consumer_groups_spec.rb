...
assert_equal 1, Karafka::App.routes.first.topics.size
assert_equal "topic1", Karafka::App.routes.first.topics.first.name
assert_equal "topic1", Karafka::App.routes.last.topics[0].name
assert_equal "topic2", Karafka::App.routes.last.topics[1].name

t1 = Karafka::App.routes.first.topics.first.kafka
t2 = Karafka::App.routes.last.topics.first.kafka
t3 = Karafka::App.routes.last.topics.last.kafka
