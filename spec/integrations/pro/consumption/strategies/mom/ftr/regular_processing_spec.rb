...
# With MoM + FTR enabled, messages should process correctly with throttling
# and offsets should not be auto-committed when mark_as_consumed is not called
...
# All offsets should be in order
previous = -1
