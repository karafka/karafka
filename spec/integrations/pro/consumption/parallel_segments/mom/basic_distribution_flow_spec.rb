...
# With manual offset management, messages should be distributed correctly but no automatic marking
# should occur
...
assert_equal 0, fetch_next_offset(consumer_group_id: Karafka::App.consumer_groups.first.id)
assert_equal 0, fetch_next_offset(consumer_group_id: Karafka::App.consumer_groups.last.id)
