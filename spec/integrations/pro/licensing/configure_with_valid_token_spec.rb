...
assert const_visible?("Karafka::Pro::Routing::Features::ConsumerGroups::LongRunningJob::ConsumerGroupTopic")
assert const_visible?("Karafka::Pro::Routing::Features::ConsumerGroups::LongRunningJob::Contracts")
assert const_visible?("Karafka::Pro::Routing::Features::ConsumerGroups::LongRunningJob::Config")
assert const_visible?("Karafka::Pro::Routing::Features::ConsumerGroups::VirtualPartitions::ConsumerGroupTopic")
assert const_visible?("Karafka::Pro::Routing::Features::ConsumerGroups::VirtualPartitions::Contracts")
assert const_visible?("Karafka::Pro::Routing::Features::ConsumerGroups::VirtualPartitions::Config")
