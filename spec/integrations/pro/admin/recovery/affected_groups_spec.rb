...
result1 = Karafka::Admin::Recovery.affected_groups(partition1, start_time: Time.now - 60)
...
if partition1 == partition2
  ...
  result2 = Karafka::Admin::Recovery.affected_groups(partition2, start_time: Time.now - 60)
