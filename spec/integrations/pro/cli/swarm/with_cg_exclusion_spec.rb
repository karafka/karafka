...
# Karafka in swarm should properly handle consumer group exclusion flag
# and skip processing the specified consumer groups
...
assert(
  ...
  "Should NOT have messages from excluded group's topic #{t1}"
)
