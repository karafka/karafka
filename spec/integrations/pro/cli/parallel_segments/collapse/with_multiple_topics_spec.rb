...
offsets = Karafka::Admin.read_lags_with_offsets({ DT.group => topics })

topics.each do |topic_name|
  assert_equal 3, offsets[DT.group][topic_name][0][:offset]
  assert_equal 2, offsets[DT.group][topic_name][1][:offset]
end
