...
RSpec.describe_current do
  let(:consumer) { Class.new { include Karafka::Pro::Processing::ConsumerGroups::OffsetMetadata::Consumer }.new }
  let(:topic) { build(:routing_topic) }
  let(:partition) { 5 }
  let(:fetcher) { Karafka::Pro::Processing::ConsumerGroups::OffsetMetadata::Fetcher }
