...
RSpec.describe_current do
  ...
  let(:collapser) { Karafka::Pro::Processing::ConsumerGroups::Collapser.new }
  let(:manager) do
    Karafka::Pro::Processing::ConsumerGroups::Coordinators::VirtualOffsetManager.new("topic", 0, :exact)
  end
