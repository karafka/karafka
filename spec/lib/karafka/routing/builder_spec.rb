...
RSpec.describe_current do
  ...
  describe '#draw' do
    context 'when we use simple topic style' do
      ...
      it { expect(topic1.subscription_group_id).not_to eq(nil) }
      it { expect(topic1.name).to eq 'topic_name1' }
      it { expect(topic2.name).to eq 'topic_name2' }
      it { expect(topic2.subscription_group_id).not_to eq(nil) }
    ...
    context 'when we use simple topic style with one subscription group and one topic' do
      ...
      it { expect(topic.subscription_group_id).to eq 'test' }
    end
    ...
    context 'when we use simple topic style with one subscription group and two topics' do
      ...
      it { expect(topic1.subscription_group_id).to eq 'test' }
      it { expect(topic2.subscription_group_id).to eq 'test' }
    end
    ...
    context 'when we use simple topic style with many subscription groups' do
      ...
      it { expect(topic1.subscription_group_id).to eq 'test1' }
      it { expect(topic2.subscription_group_id).to eq 'test2' }
    end
