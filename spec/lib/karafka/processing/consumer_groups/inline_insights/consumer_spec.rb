...
RSpec.describe_current do
  let(:consumer) { Class.new { include Karafka::Processing::ConsumerGroups::InlineInsights::Consumer }.new }
  let(:topic) { build(:routing_topic) }
  let(:partition) { 5 }
  let(:tracker) { Karafka::Processing::ConsumerGroups::InlineInsights::Tracker.instance }
