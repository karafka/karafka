  ...
  module Routing
    module ShareGroups
      module Contracts
        ...
        # consumer topics, but omits consumer-group-only routing features that are not prepended
        # onto share topics (e.g. `deserializers`, `pause`). Those consumer-group features will be
        # duplicated for share groups when the share-group runtime lands. Reuses the `routing.topic`
        # locale messages.
