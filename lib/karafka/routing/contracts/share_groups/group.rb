  ...
  module Routing
    module Contracts
      ...
      module ShareGroups
        ...
        # the rules currently mirror {ConsumerGroups::Group}. It is a dedicated contract (the
        # contract DSL does not inherit rules) so share-group-specific validations can be added
