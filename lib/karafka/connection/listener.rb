    ...
    class Listener
      ...
      def build_and_schedule_flow_jobs
        ...
        @messages_buffer.each do |topic, partition, messages, eof, last_polled_at|
          ...
          # When eof is true alongside messages, coordinator.eofed? will return true during the
          # consume callback, allowing users to detect this condition without a separate eofed job.
          #
          # Start work coordination for this topic partition
