...
module Karafka
  module Instrumentation
    ...
    module Listener
      ...
      # A bit of meta-programming that might need an explanation
      # We do that so this API module can be used ont only as a part of something else
      # (via include) but also can be used standalone (since we extend ourselfs with self)
      # To keep things organized, we also "hide" logger aliases as private when used from
      # the self-standing perspective
      extend self
