  ...
  module Processing
    module ConsumerGroups
      ...
      class JobsQueue
        ...
        # @return [Karafka::Processing::ConsumerGroups::JobsQueue]
        def initialize
          @queue = Queue.new
        ...
        # @return [Jobs::Base, nil] waits for a job from the main queue and returns it once
        #   available or returns nil if the queue has been stopped and there won't be anything
        #   more to process ever.
        ...
        # Marks a given job from a given group as completed. When there are no more jobs from a
        # given group to be executed, we won't wait.
        #
